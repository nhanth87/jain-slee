...
| | Restcomm JAIN SLEE 1.1 | micro-jainslee |
|---|---|---|
| **Lines of code** | ~175,000 | **~17,000** (90% less) |
| **Container** | JBoss/WildFly 10 | **None — embeds in Quarkus** |
| **Startup time** | 30–60 seconds | **< 2 seconds** |
| **Event bus** | JMX MBeans + JMS | **LMAX Disruptor (6M events/s)** |
| **Concurrency** | Platform threads | **Virtual threads (Loom)** |
| **GraalVM Native** | Impossible | **In progress** |
| **Memory baseline** | ~500 MB | **~30 MB** |
| **Deployment** | WAR/EAR to app server | **1 JAR + mvn quarkus:dev** |

> Restcomm's JAIN SLEE 1.1 master branch is an **excellent, battle-tested implementation** — the gold standard for the spec. micro-jainslee takes the same contract surface and makes it **10x lighter, 100x faster to start, and embeddable anywhere**. We stand on the shoulders of giants.
