...
/**
 * A framework-neutral HTTP response produced by a handler and translated by
 * {@code HttpGatewaySbb} into an {@code HttpResponseExCommand} on the
 * {@code ra-http-server} command port. No Vert.x types leak into the app.
 *
